 ...
 * colors.ts
 * -----------------------------------------------------------------------
 * 블록 타입별 렌더링 색상을 정의한다. 프로젝트 최초 플레이 버전의 밝은 7색 팔레트를
 * 사용해 조각을 빠르게 구분하고, 어두운 배경에서 네온처럼 발광하도록 구성한다.
 *
...
/** 최초 버전의 블록 기본색 - I=하늘, O=노랑, T=보라, S=초록, Z=빨강, J=파랑, L=주황 */
