...
export function StageStars({ count, size = 16, label }: { readonly count: number; readonly size?: number; readonly label?: string }) {
  return <span role="img" aria-label={label ?? `획득 별 ${count} / 3`} className="inline-flex items-center justify-center gap-1">
